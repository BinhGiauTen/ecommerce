...
<body>
	<div class="main">
		...
		<nav class="nav__mini">
			<div class="grid wide">
				<span><a href="/Ecommerce/Home">Trang chủ</a> > Giỏ hàng</span>
			</div>
		</nav>
									...
									<div class="cart-label-other">
										<div class="cart-price">
											<div class="cart__price-old">
												<fmt:formatNumber value="${cartItem.oldPrice}" type="number"
													pattern="#,##0" />
												đ
											</div>
										...
										<div class="cart-quantity">
											<input type="number" class="quantityInput"
												data-id="${cartItem.productId}" name="quantity"
												value="${cartItem.quantity}" min="1">
										</div>
										<div>
											<fmt:formatNumber value="${cartItem.totalCost}" type="number"
												pattern="#,##0" />
											đ
										</div>
										<div>
											<input type="hidden" name="productId"
												value="${cartItem.productId}"> <input type="submit"
												name="action" value="Cập nhật"> <input type="submit"
												name="action" value="Xóa">
										</div>
									</div>
								</div>
							</form>
