...
<body>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card-box" style="padding: 20px">
						<form action="/Ecommerce/AddCategory" method="post" id="form-1">
							<div class="form-group">
								<label for="category_id">Mã danh mục</label> <input type="text"
									class="form-control" id="category_id"
									value="${category != null ? category.categoryId : ''}"
									name="category_id"> <span class="form-message"></span>
							</div>
							<div class="form-group">
								<label for="category_name">Tên danh mục</label> <input
									type="text" class="form-control" id="category_name"
									value="${category != null ? category.categoryName : ''}"
									name="category_name"> <span class="form-message"></span>
							</div>
	...
	<script>
		document.addEventListener("DOMContentLoaded", function() {
			Validator({
				...
				rules : [ Validator.isRequired('#category_id'),
						Validator.isRequired('#category_name'), ],
	...
	<script>
    document.addEventListener('DOMContentLoaded', function() {
        var isAdmin = ${account != null && account.isAdmin ? 'true' : 'false'};
        if (isAdmin) {
