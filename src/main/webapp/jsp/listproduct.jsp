...
<head>
	...
	<!-- CSS -->
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/dashboard/styles/core.css">
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/dashboard/styles/icon-font.min.css">
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/dashboard/styles/style.css">
...
<body>
        ...
        <div class="pd-ltr-20">
            <div class="card-box pd-20 height-100-p mb-30">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="font-20 weight-500 mb-10 text-capitalize">Danh sách sản phẩm</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                                ...
                                <c:forEach var="product" items="${listP}">
                                    <tr>
										...
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												<form action="ListProduct" method="post" style="display:inline;">
														<input type="hidden" name="action" value="update">
														<input type="hidden" name="productId" value="${product.productId}">
														<button type="submit" class="dropdown-item"><i class="dw dw-edit2"></i> Cập nhật</button>
												</form>
												<form action="ListProduct" method="post" style="display:inline;">
                                                    <input type="hidden" name="action" value="delete">
                                                    <input type="hidden" name="productId" value="${product.productId}">
                                                    <button type="submit" class="dropdown-item" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này không?');"><i class="dw dw-delete-3"></i> Xóa</button>
                                                </form>
											</div>
										</div>
									</td>
	...
	<script src="<%=request.getContextPath()%>/dashboard/scripts/script.min.js"></script>
	<script src="<%=request.getContextPath()%>/dashboard/scripts/layout-settings.js"></script>
	<script src="<%=request.getContextPath()%>/dashboard/scripts/apexcharts.min.js"></script>
	<script src="<%=request.getContextPath()%>/dashboard/scripts/dashboard.js"></script>
</body>
</html>